...
<div class="grid simple">
    ...
    <div class="grid-body">
        <form action="{$url.admin}/update_page/{$ed->page_id}/{$ed->page_slug}" method="post" class="validate">
            {$csrf_token}
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="page_name">Page Name</label>
                        <input id="page_name" class="form-control" type="text" value="{$ed->page_name}" name="page_name" maxlength="20" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="code" class="form-control" name="page_contents" rows="3" required>{$ed->page_contents}</textarea>
                    </div>
                </div>
